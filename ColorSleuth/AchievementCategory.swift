...
struct AchievementCategory: View {
    ...
    var body: some View {
				ScrollView {
						...
						VStack {
								AchievementGroup(section: "Games Played", description1: "Play 25\nGames", 
																 description2: "Play 100\nGames", description3: "Play 250\nGames",
																 description4: "Play 500\nGames", description5: "Play 1000\nGames",
																 description6: "Play 5000\nGames")
								Divider()
										.padding(.leading)
								AchievementGroup(section: "Perfect Games", description1: "25 Perfect\nGames",
								...
								Divider()
										.padding(.leading)
								AchievementGroup(section: "Streaks", description1: "Streak\nof 25",
																 description2: "Streak\nof 50", description3: "Streak\nof 100",
																 description4: "Streak\nof 200", description5: "Streak\nof 500",
																 description6: "Streak\nof 1000")
								Divider()
										.padding(.leading)
								AchievementGroup(section: "Total Times", description1: "Complete 750\nrounds under\n35 seconds",
