				...
				context.insert(AchievementModel(difficulty: "Easy",
																				...
																				groups: [GroupModel(name: "Games Played",
																								 ...
																								 GroupModel(name: "Times",
																											 ...
																											 progress: 0,
																														// old: 12 and 10
																														goals: [Goal(value: 250, time: 11.5, isComplete: false),
																																		Goal(value: 500, time: 11.5, isComplete: false),
																																		Goal(value: 1000, time: 11.5, isComplete: false),
				...
				context.insert(AchievementModel(difficulty: "Medium",
																				...
																				groups: [GroupModel(name: "Games Played",
																								 ...
																								 GroupModel(name: "Best Time",
																														...
																														descriptionString: "Win _ game under - seconds",
																														progress: 0,
																														goals: [Goal(value: 1, time: 9.7, isComplete: false),
				...
				context.insert(AchievementModel(difficulty: "Hard",
																				...
																				groups: [GroupModel(name: "Games Played",
																								 ...
																								 GroupModel(name: "Times",
																											 ...
																											 descriptionString: "Win _ games under - seconds",
																											 progress: 0,
																											 goals: [Goal(value: 250, time: 13, isComplete: false),
																															 Goal(value: 500, time: 13, isComplete: false),
																															 Goal(value: 1000, time: 13, isComplete: false),
																															 Goal(value: 100, time: 11.5, isComplete: false),
																															 Goal(value: 250, time: 11.5, isComplete: false),
																															 Goal(value: 500, time: 11.5, isComplete: false)]),
																								 GroupModel(name: "Best Time",
																														index: 4,
																														descriptionString: "Win _ game under - seconds",
																														progress: 0,
																														// old 10.4, 10.2, 10
																														goals: [Goal(value: 1, time: 10.3, isComplete: false),
																																		Goal(value: 1, time: 10.1, isComplete: false),
																																		Goal(value: 1, time: 9.9, isComplete: false)])]))
				context.insert(AchievementModel(difficulty: "Extreme",
																				...
																				groups: [GroupModel(name: "Games Played",
																								 ...
																								 GroupModel(name: "Best Time",
																														...
																														progress: 0,
																														// old: 14.2, 14, 13.8
																														goals: [Goal(value: 1, time: 14, isComplete: false),
																																		Goal(value: 1, time: 13.8, isComplete: false),
																																		Goal(value: 1, time: 13.5, isComplete: false)])]))
